...
"""
    ...
    print(Fore.YELLOW + "[+] " + Fore.GREEN + "Tool Name:PhoneNumber OSINT\n" + Fore.YELLOW + "[+] " + Fore.GREEN + "$TEKNIK HACKING)\n" + Fore.YELLOW + "[+] " + Fore.GREEN + "Version:1.6\n" + Fore.YELLOW + "[+] " + Fore.GREEN + "Team:TermuxHackz Society\n" + Fore.YELLOW + "[+] " + Fore.GREEN + "Github:https://github.com/rizkyori\n" + Fore.YELLOW + "[+] " + Fore.GREEN + "WhatsApp:+6285762228014")
...
#           z = str(extracting)
        ...
        t. sleep(3)
        os.system ("https://chat.whatsapp.com/FqM6BfHV2A")
    elif option == 7:
